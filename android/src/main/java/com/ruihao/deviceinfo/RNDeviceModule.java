...
public class RNDeviceModule extends ReactContextBaseJavaModule {
    ...
    public RNDeviceModule(ReactApplicationContext reactContext) {
        ...
        String wifi = Context.WIFI_SERVICE;

        WifiManager manager = (WifiManager) reactContext.getSystemService(wifi);
    ...
    public @Nullable Map<String, Object> getConstants() {
        ...
        String appName =  this.reactContext.getApplicationInfo().loadLabel(pm).toString();
